...
# Create dummy libraries so we won't have to remove them in OpenJDK makefiles
  ...
  sameflags="-arch arm64 -DHEADLESS=1 -I$PWD/ios-missing-include -Wno-implicit-function-declaration -Wno-error=implicit-function-declaration -Wno-error=macro-redefined -fno-define-target-os-macros -DTARGET_OS_OSX"
